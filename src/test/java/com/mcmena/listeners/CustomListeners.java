...
public abstract class CustomListeners extends CommonLibs implements ITestListener,ISuiteListener {
	...
	public void onTestFailure(ITestResult arg0) {
		...
		test.log(LogStatus.FAIL, " Failed with exception : "+arg0.getThrowable());
