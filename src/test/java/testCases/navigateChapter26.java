...
public class navigateChapter26 extends CommonLibs {
	ExcelLibs exl;
...
//	}
	@Test (priority=2, alwaysRun=true, description = "Start USMO6") 
	...
	shtobj = excel.getSheetObject(filepath, "USMO6");
	...
	for(int rowValue=1; rowValue <= rowCount; rowValue++) {
		...
		{
			temp = "Done";
			excel.setCellData("USMO6", "Status", rowValue+1, temp);
		...
		{
			tempb="Published";
			excel.setCellData("USMO6", "publish_Status", rowValue+1, tempb);
