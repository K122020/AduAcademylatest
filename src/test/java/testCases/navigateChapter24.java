...
public class navigateChapter24 extends CommonLibs {
	ExcelLibs exl;
...
//	}
	@Test (priority=2, alwaysRun=true, description = "Start USMO4") 
	...
	shtobj = excel.getSheetObject(filepath, "USMO4");
	...
	for(int rowValue=1; rowValue <= rowCount; rowValue++) {
		...
		{
			temp = "Done";
			excel.setCellData("USMO4", "Status", rowValue+1, temp);
		...
		{
			tempb="Published";
			excel.setCellData("USMO4", "publish_Status", rowValue+1, tempb);
