...
public class navigateChapter33 extends CommonLibs {
	ExcelLibs exl;
...
//	}
	@Test (priority=2, alwaysRun=true, description = "Start USMO13") 
	...
	shtobj = excel.getSheetObject(filepath, "USMO13");
	...
	for(int rowValue=1; rowValue <= rowCount; rowValue++) {
		...
		{
			temp = "Done";
			excel.setCellData("USMO13", "Status", rowValue+1, temp);
		...
		{
			tempb="Published";
			excel.setCellData("USMO13", "publish_Status", rowValue+1, tempb);
