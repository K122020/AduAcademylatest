...
import pages.NextPage3;
import pages.SignOutPage;

public class navigateChapter5 extends CommonLibs {
	ExcelLibs exl;
	...
	for(int rowValue=1; rowValue <= rowCount; rowValue++) {
		...
		{
			tempb="Published";
			excel.setCellData("USMO", "publish_Status", rowValue+1, tempb);
