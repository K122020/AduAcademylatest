...
public class navigateChapter27 extends CommonLibs {
	ExcelLibs exl;
...
//	}
	@Test (priority=2, alwaysRun=true, description = "Start USMO7") 
	...
	shtobj = excel.getSheetObject(filepath, "USMO7");
	...
	for(int rowValue=1; rowValue <= rowCount; rowValue++) {
		...
		{
			temp = "Done";
			excel.setCellData("USMO7", "Status", rowValue+1, temp);
		...
		{
			tempb="Published";
			excel.setCellData("USMO7", "publish_Status", rowValue+1, tempb);
