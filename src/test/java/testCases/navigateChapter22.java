...
public class navigateChapter22 extends CommonLibs {
	ExcelLibs exl;
...
//	}
	@Test (priority=2, alwaysRun=true, description = "Start USMO2") 
	...
	shtobj = excel.getSheetObject(filepath, "USMO2");
	...
	for(int rowValue=1; rowValue <= rowCount; rowValue++) {
		...
		{
			temp = "Done";
			excel.setCellData("USMO2", "Status", rowValue+1, temp);
		...
		{
			tempb="Published";
			excel.setCellData("USMO2", "publish_Status", rowValue+1, tempb);
