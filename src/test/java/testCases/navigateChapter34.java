...
public class navigateChapter34 extends CommonLibs {
	ExcelLibs exl;
...
//	}
	@Test (priority=2, alwaysRun=true, description = "Start USMO14") 
	...
	shtobj = excel.getSheetObject(filepath, "USMO14");
	...
	for(int rowValue=1; rowValue <= rowCount; rowValue++) {
		...
		{
			temp = "Done";
			excel.setCellData("USMO14", "Status", rowValue+1, temp);
		...
		{
			tempb="Published";
			excel.setCellData("USMO14", "publish_Status", rowValue+1, tempb);
